...
if (strlen($_SESSION['aid']) == 0) {   
    ...
    if (isset($_POST['submit'])) {
        ...
        $role = $_POST['role'];
        $id = intval($_GET['id']);
        $sql = mysqli_query($con, "UPDATE studentaffaris SET first_name='$firstname', last_name='$lastname', email='$email', role='$role' WHERE id='$id'");
        $_SESSION['msg'] = "Student Affaris Updated !!";
...
<html lang="en">
<head>
    <title>SCMS||Update Student Affaris</title>
    <!-- vendor css -->
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Update Student Affairs</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="addstudentaffairs.php">Update Student Affairs</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <?php
                                $id = intval($_GET['id']);
                                $query = mysqli_query($con, "SELECT * FROM studentaffaris WHERE id='$id'");
