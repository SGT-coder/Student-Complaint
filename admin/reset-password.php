...
$sql =mysqli_query($con,"SELECT id FROM admin WHERE email='$email' and hobby='$hobby'");
$rowcount=mysqli_num_rows($sql);

if($rowcount >0)
{
$query=mysqli_query($con,"update admin set password='$newpassword' where email='$email' and hobby='$hobby'");
if($query){
...
<head>
	<title>SCMS | Admin Password Recovery</title>
			...
			<div class="row align-items-center ">
				<div class="col-md-12">
					...
					<div class="card-body">
						...
						<div class="form-group mb-3">
							<input type="text" class="form-control" placeholder="Write your hobby" name="hobby"  required>
						</div>
						<div class="form-group mb-3">
