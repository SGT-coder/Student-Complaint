...
<html lang="en">
<head>
    <title>SCMS||Update Faculty Dean</title>
    <!-- vendor css -->
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Update Faculty Dean</h5>
                            </div>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="dashboard.php"><i class="feather icon-home"></i></a></li>
                                <li class="breadcrumb-item"><a href="depthead.php">Update Faculty Dean</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
