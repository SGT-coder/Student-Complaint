...
<head>
    <title>SCMS|| Between Dates Users Report</title>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost:8080/cms/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
