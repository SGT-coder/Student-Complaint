...
if(strlen($_SESSION['aid'])==0) {   
    ...
    if(isset($_POST['submit'])) {
        ...
        // Redirect to state.php after updating
...
?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Enter state Name"  name="state" value="<?php echo  htmlentities($row['stateName']);?>" class="form-control" required>
                                    </div>
                                    <div class="form-group">
