                ...
                <div class="card flat-card widget-primary-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                            ...
                            <?php
                               $rolef=$_SESSION['frole'];
 $query1=mysqli_query($con,"select id from users where Faculty='$rolef' ");
                ...
                <div class="card flat-card widget-purple-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php
                             $rolef=$_SESSION['frole'];
                              $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where category='$rolef'");
                ...
                <div class="card flat-card bg-danger">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                          <?php
                           $rolef=$_SESSION['frole'];
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status is null and category = '$rolef'");
                ...
                <div class="card flat-card bg-warning">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                            $rolef=$_SESSION['frole'];
                           $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status='in process' and category = '$rolef'");
                    ...
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php
                            ...
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status='closed'and category = '$rolef'");
