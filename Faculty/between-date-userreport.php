...
$rolef=$_SESSION['frole'];
 $query=mysqli_query($con,"select * from users  where regDate between '$fdate' and '$tdate'  AND Faculty='$rolef'");
$cnt=1;
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/cms/Faculty/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
