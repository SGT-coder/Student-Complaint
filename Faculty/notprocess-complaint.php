                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                     ...
                                     $query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null AND tblcomplaints.category='$rolef' ");
$cnt=1;
