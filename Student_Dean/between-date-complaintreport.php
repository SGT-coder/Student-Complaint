...
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.regDate between '$fdate' and '$tdate' AND tblcomplaints.subcategory='$roled'");
$cnt=1;
