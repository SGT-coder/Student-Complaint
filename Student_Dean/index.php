...
$ret=mysqli_query($con,"SELECT * FROM studentdean WHERE email='$username' and password='$password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$_SESSION['sdlogin']=$username;
$_SESSION['sdid']=$num['id'];
$_SESSION['sdrole']=$num['role'];
