...
<section class="pcoded-main-container">
  ...
  $query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null AND tblcomplaints.subcategory='$roled' ");
$cnt=1;
