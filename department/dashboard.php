                ...
                <div class="card flat-card widget-primary-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                            ...
                            $query1=mysqli_query($con,"select id from users where Department = '$drole'");
              ...
              <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card widget-purple-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                            $roled=$_SESSION['drole'];
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where subcategory = '$roled'");
                ...
                <div class="card flat-card bg-danger">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                          <?php
                           $roled=$_SESSION['drole'];
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status is null and subcategory = '$roled'");
                ...
                <div class="card flat-card bg-warning">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                             $roled=$_SESSION['drole'];
                           $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status='in process' and subcategory = '$roled'");
                ...
                <div class="card flat-card widget-purple-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                            $roled=$_SESSION['drole'];
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status='closed' and subcategory = '$roled' ");
