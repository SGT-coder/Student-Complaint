                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $query = mysqli_query($con, "SELECT tblcomplaints.*, users.fullName as name FROM tblcomplaints JOIN users ON users.id = tblcomplaints.userId WHERE subcategory = '$roled'");
                                                        $cnt = 1;
