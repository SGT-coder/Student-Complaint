...
$sql =mysqli_query($con,"SELECT id FROM users WHERE userEmail='$email' and hobby='$hobby'");
$rowcount=mysqli_num_rows($sql);

if($rowcount >0)
{
$query=mysqli_query($con,"update users set password='$newpassword' where userEmail='$email' and hobby='$hobby'");
if($query){
