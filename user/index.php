...
$query=mysqli_query($con,"SELECT id,fullName,Department,Faculty FROM users WHERE userEmail='$email' and password='$password'");
...
<head>
	<title>SCMS | Student login</title>
...
<div class="auth-wrapper">
	<div class="auth-content text-center">
		<h4> Student Complaint System <hr /><span style="color:#fff;"> Student Login</span></h4>
