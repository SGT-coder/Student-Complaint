...
$rt = mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null and  subcategory = 'Registerar' || subcategory = 'Dormitary' || subcategory = 'Cafetria' ");
							...
							<div class="dropdown drp-user">
								...
								<div class="dropdown-menu dropdown-menu-right profile-notification">
									<div class="pro-head">
										...
										<?php
$idd=$_SESSION['said'];
$ret=mysqli_query($con,"select * from studentaffaris where id='$idd'");
