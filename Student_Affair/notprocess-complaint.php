...
<section class="pcoded-main-container">
  ...
  $query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where tblcomplaints.status is null AND (subcategory = 'Library'  || subcategory = 'Security') ");
$cnt=1;
