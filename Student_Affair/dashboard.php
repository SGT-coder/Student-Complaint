                    ...
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                            ...
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints  where (subcategory = 'Library'  || subcategory = 'Security') ");
                    ...
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                          <?php
                            ...
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status is null and  (subcategory = 'Library'  || subcategory = 'Security')");
              ...
              <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card bg-warning">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                           $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status='in process' AND ( subcategory = 'Library'  || subcategory = 'Security')");
              ...
              <div class="col-md-12 col-xl-4">
                ...
                <div class="card flat-card widget-purple-card">
                    <div class="row-table">
                        ...
                        <div class="col-sm-9">
                           <?php 
                            $query5=mysqli_query($con,"select complaintNumber from tblcomplaints where status='closed' AND (subcategory = 'Library'  || subcategory = 'Security' ) ");
